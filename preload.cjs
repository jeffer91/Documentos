...
contextBridge.exposeInMainWorld("documentosApp", {
  ...
  cloneDossier: (sourceDossierId, targetPeriodId, label) => ipcRenderer.invoke("dossiers:clone", sourceDossierId, targetPeriodId, label || ""),
  ...
  suggestDataMapping: (importId) => ipcRenderer.invoke("data-imports:suggest-mapping", importId),
  ...
  getAiDataSlice: (dossierId, query) => ipcRenderer.invoke("data-ai-slice", dossierId, query || {}),
  ...
  setDocumentSectionIncluded: (instanceId, sectionKey, included) => ipcRenderer.invoke("instances:set-section-included", instanceId, sectionKey, included !== false),
  ...
  recommendEngineSections: (instanceId, options) => ipcRenderer.invoke("ai-engine:recommend-sections", instanceId, options || {}),
